...
class AddParticipantVM extends BaseViewModel {
  XFile? file;
  String? url = '';
  ...
  onSave(tournamentName, index) async {
    if (formKey.currentState!.validate()) {
      ...
      // print('Image URL: $url');
      await addParticipant(tournamentName);
      NavigationService().replaceWithParticipantView(
          originalTitle: tournamentName, index: index);
    } else {
  ...
  Future<void> addParticipant(tournamentName) async {
