...
// import 'package:tournament_manager/views/modify_matches/randomly/modify_match_randomly_vm.dart';

// class ModifyMatchesView extends StatelessWidget {
//   final String tournamentName;
//   final String originalTitle;
//   final int index;
//   const ModifyMatchesView(
//       {super.key,
...
//       viewModelBuilder: () => ModifyMatchesVM(),
...
//                 //   sublabel: 'Create matches manually',
//                 //   onTap: viewModel.generateManually,
//                 // ),
//               ],
//             ),
//           ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    generateButton(
                      ...
                      onTap: () {
                        //dailog box asking are you sure you want to generate matches randomly
                        showDialog(
                          context: context,
                          builder: (context) {
                            return AlertDialog(
                                ...
                                TextButton(
                                  onPressed: () async {
                                    SnackbarService().showSnackbar(
                                      message: 'Matches are being regenerated',
                                      duration: const Duration(seconds: 2),
                                    );
                                    Navigator.of(context).pop();
                                    await viewModel
                                        .onDeleteMatchesandMatchRules(
                                            originalTitle);
                      ...
                      onTap: () async {
                        ...
                        locator<NavigationService>().navigateTo(
                          ...
                          arguments: ModifyMatchesManuallyViewArguments(
                            originalTitle: originalTitle,
                            allPlayers:
                                viewModel.userService.allParticipantsName,
                          ),
                        );
                      },
                    ),
